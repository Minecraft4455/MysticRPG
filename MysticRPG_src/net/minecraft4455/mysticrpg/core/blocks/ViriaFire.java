...
public class ViriaFire extends BlockFire {
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4) {
		if ((par1World.getBlockId(par2, par3 - 1, par4) != MysticBlocks.YirawiaBlock.blockID)
				|| (!((YirawiaPortal) MysticBlocks.YirawiaPortal).tryToCreatePortal(par1World, par2,
						par3, par4))) {
			if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4))
					&& (!canNeighborBurn(par1World, par2, par3, par4))) {
				par1World.setBlockToAir(par2, par3, par4);
	...
	public void randomDisplayTick(World par1World, int par2, int par3,
		...
		if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4))
				&& (!((ViriaFire) MysticBlocks.ViriaFire).canBlockCatchFire(par1World, par2,
						par3 - 1, par4, ForgeDirection.UP))) {
			if (((ViriaFire) MysticBlocks.ViriaFire).canBlockCatchFire(par1World, par2 - 1, par3,
			...
			if (((ViriaFire) MysticBlocks.ViriaFire).canBlockCatchFire(par1World, par2, par3,
			...
			if (((ViriaFire) MysticBlocks.ViriaFire).canBlockCatchFire(par1World, par2, par3 + 1,
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.iconArray = new Icon[] {
				par1IconRegister.registerIcon(MysticModInfo.MODID + ":ViriaFire_0"),
				par1IconRegister.registerIcon(MysticModInfo.MODID + ":ViriaFire_1") };
	}
