...
public class YirawiaGrass extends Block {
	...
	public Icon getIcon(int par1, int par2) {
		return par1 == 1 ? this.iconGrassTop : (par1 == 0 ? MysticBlocks.YirawiaDirt
	...
	public void updateTick(World par1World, int par2, int par3, int par4,
		...
		if (!par1World.isRemote) {
			if (par1World.getBlockLightValue(par2, par3 + 1, par4) < 4
				...
				par1World.setBlock(par2, par3, par4, MysticBlocks.YirawiaDirt.blockID);
				...
				for (int l = 0; l < 4; ++l) {
					...
					if (par1World.getBlockId(i1, j1, k1) == MysticBlocks.YirawiaDirt.blockID
						...
						par1World.setBlock(i1, j1, k1, MysticBlocks.YirawiaDirt.blockID);
					}
				}
			}
		}
	...
	public void registerIcons(IconRegister par1IconRegister) {
		...
		this.blockIcon = par1IconRegister.registerIcon(MysticModInfo.MODID + ":YirawiaGrassSide");
		this.iconGrassTop = par1IconRegister.registerIcon(MysticModInfo.MODID + ":YirawiaGrassTop");
