            ...
            for (k1 = l - short1; k1 <= l + short1; ++k1) {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
                    ...
                    for (int i2 = worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
                        /** change this block **/
                        if (worldServerInstance.getBlockId(k1, i2, l1) == MysticBlocks.YirawiaPortal.blockID) {
                            /** change this block **/
                            while (worldServerInstance.getBlockId(k1, i2 - 1,
                                    l1) == MysticBlocks.YirawiaPortal.blockID) {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D) {
            if (flag) {
                destinationCoordinateCache
                        .add(j1, new YirawiaPortalPosition(this, i, j, k,
            ...
            d4 = k + 0.5D;
            int j2 = -1;
            if (worldServerInstance.getBlockId(i - 1, j, k) == MysticBlocks.YirawiaPortal.blockID) {
                j2 = 2;
            }
            if (worldServerInstance.getBlockId(i + 1, j, k) == MysticBlocks.YirawiaPortal.blockID) {
                j2 = 0;
            }
            if (worldServerInstance.getBlockId(i, j, k - 1) == MysticBlocks.YirawiaPortal.blockID) {
                j2 = 3;
            }
            if (worldServerInstance.getBlockId(i, j, k + 1) == MysticBlocks.YirawiaPortal.blockID) {
                j2 = 1;
