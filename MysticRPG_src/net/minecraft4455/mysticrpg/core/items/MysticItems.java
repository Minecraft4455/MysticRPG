...
public class MysticItems {
	...
	private static void initItems() {
		...
		BlackMercySeed = new BlackMercySeed(MysticConfig.BlackMercySeedID, MysticConfig.BlackMercyID, Block.tilledField.blockID).setUnlocalizedName("BlackMercySeed");
		BlackMercySubstance = new BlackMercySubstance(MysticConfig.BlackMercySubstanceID).setUnlocalizedName("BlackMercySubstance");
		NatureScroll = new NatureScroll(MysticConfig.NatureScrollID).setUnlocalizedName("NatureScroll");
		GreenInk = new GreenInk(MysticConfig.GreenInkID).setUnlocalizedName("GreenInk");
		GreenInkWitgFeather = new GreenInkWithFeather(MysticConfig.GreenInkWithFeatherID).setUnlocalizedName("GreenInkWitgFeather");
