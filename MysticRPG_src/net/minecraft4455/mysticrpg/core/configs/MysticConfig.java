...
public class MysticConfig {
	...
	public static @CfgID int ScrollID = 6000;
	public static @CfgID int BlackMercySeedID = 6001;
	public static @CfgID int BlackMercySubstanceID = 6002;
	public static @CfgID int NatureScrollID = 6003;
	public static @CfgID int GreenInkID = 6004;
	public static @CfgID int GreenInkWithFeatherID = 6005;
	
	public static @CfgID(block = true) int BlackMercyID = 3000;
	public static @CfgID(block = true) int YirawiaPortalID = 3001;
	public static @CfgID(block = true) int YirawiaBlockID = 3002;
	public static @CfgID(block = true) int ViriaFireID = 3003;
